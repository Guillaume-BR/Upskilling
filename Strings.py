my_list= ["eda","jgs","ozje"]
print(my_list[1])

print("31555821AB0509"[:-6])

print("le test".capitalize())

print("Sarkozy Hollande Sarkozy".islower())
...
print("Président Trump".replace("Trump","Biden"))
...
print(a.count("France"))

#exercice: découpez la date “2024-02-12”

print("2024-02-14".split("-"))